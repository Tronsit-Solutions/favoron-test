  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      <Dialog open={showPreview} onOpenChange={setShowPreview}>
        <DialogContent className="max-w-screen-lg max-h-screen w-[95vw] h-[95vh] overflow-auto p-6">
          <DialogHeader>
            <div className="flex items-center justify-between">
          ...
          <div className="mt-6 flex flex-col items-center">
            <div className="space-y-4">
              <div className="bg-gray-100 rounded-2xl p-2 border-2 border-gray-300 max-w-fit">
                <div ref={instagramRef}>
                  <InstagramTripPreview trips={trips} searchTerm={searchTerm} />
                </div>
              </div>
