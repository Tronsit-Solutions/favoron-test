...
export const GMVChart = ({ data }: GMVChartProps) => {
  const chartData = useMemo(() => {
    ...
    return data.map(d => {
      accumulated += d.gmv;
      return { ...d, accumulatedGmv: accumulated };
    });
  }, [data]);
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>Valor bruto de mercancía mensual y acumulado</CardDescription>
          </div>
          <div className="text-right">
            <div className="text-2xl font-bold">Q{totalGMV.toLocaleString('es-GT', { minimumFractionDigits: 0, maximumFractionDigits: 0 })}</div>
