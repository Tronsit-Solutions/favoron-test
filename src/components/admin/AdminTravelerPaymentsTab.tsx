      ...
      <Tabs defaultValue="pending" className="space-y-4">
        <TabsList className="grid w-full grid-cols-2">
          <TabsTrigger value="pending" className="relative flex items-center gap-2">
            Órdenes Pendientes
            {pendingOrders.length > 0 && <Badge variant="destructive" className="ml-1 text-xs">
          ...
          {pendingOrders.length === 0 ? <Card>
              ...
              <CardContent>
                <Table>
                  ...
                  <TableBody>
                    {pendingOrders.map(order => <TableRow key={order.id}>
                          <TableCell>
                            <div>
                        ...
                        <TableCell>
                          <div className="flex gap-2">
                            ...
                            <Button size="sm" variant="default" onClick={() => setConfirmDialog({
                        isOpen: true,
                        action: 'complete',
                        order
                      })}>
                            ...
                            <Button size="sm" variant="destructive" onClick={() => setConfirmDialog({
                        isOpen: true,
                        action: 'reject',
                        order
                      })}>
