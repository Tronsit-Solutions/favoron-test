...
const AddressDisplay = ({
  ...
  return <div className={`${variantStyles[variant]} border rounded-lg p-4`}>
      ...
      <div className="text-sm ml-7 space-y-1">
        ...
        {address.hotelAirbnbName && <p className="font-medium">{address.hotelAirbnbName}</p>}
        <p className="flex items-center">
          <span className="mr-1">Destinatario: Lucas Farias</span>
