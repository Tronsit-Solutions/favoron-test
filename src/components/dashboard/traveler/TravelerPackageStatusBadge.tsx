...
const TRAVELER_STATUS_MAP: Record<string, StatusConfig> = {
  ...
  payment_pending: {
    ...
    description: "El shopper aceptó la cotización y está pendiente de realizar el pago.",
    bgColor: "bg-amber-50",
    textColor: "text-amber-600",
    actionMessage: "Esperando que el shopper complete el pago.",
  },
  rejected: {
    emoji: "❌",
    label: "Rechazado",
    description: "El viajero rechazó este paquete.",
    bgColor: "bg-red-50",
  ...
  pending_office_confirmation: {
    ...
    description: "Declaraste la entrega - Esperando que la oficina de Favorón confirme la recepción",
    bgColor: "bg-amber-50",
    textColor: "text-amber-600",
    actionMessage: "⏳ Has declarado la entrega del paquete. Una vez que Favorón confirme la recepción, podrás crear tu orden de cobro.",
  },
  delivered_to_office: {
    emoji: "✅",
    label: "Entrega confirmada",
    description: "Entrega confirmada por Favorón.",
    bgColor: "bg-green-50",
    textColor: "text-green-600",
    actionMessage: "✅ La oficina confirmó la recepción. Cuando todos tus paquetes estén confirmados podrás crear tu orden de cobro.",
  },
  ready_for_pickup: {
    emoji: "📦",
