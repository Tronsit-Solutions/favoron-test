...
-- Crear índices para mejorar el rendimiento de los reportes
CREATE INDEX IF NOT EXISTS idx_packages_created_at_month ON packages (DATE_TRUNC('month', created_at));
CREATE INDEX IF NOT EXISTS idx_trips_created_at_month ON trips (DATE_TRUNC('month', created_at));
CREATE INDEX IF NOT EXISTS idx_packages_status_created_at ON packages (status, created_at);
CREATE INDEX IF NOT EXISTS idx_trips_status_created_at ON trips (status, created_at);