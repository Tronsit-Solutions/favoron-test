-- Fix the get_monthly_reports function with correct column references
DROP FUNCTION IF EXISTS public.get_monthly_reports(date, date);
...
BEGIN
  ...
  IF start_date IS NULL THEN
    start_date := DATE_TRUNC('month', CURRENT_DATE - INTERVAL '11 months')::date;
  END IF;
