-- Crear función para notificar a admins cuando se crea una orden de pago
...
-- Crear trigger que se ejecuta cuando se inserta una nueva orden de pago
CREATE TRIGGER trigger_notify_admins_payment_order
  AFTER INSERT ON public.payment_orders
  FOR EACH ROW
  EXECUTE FUNCTION public.notify_admins_payment_order();